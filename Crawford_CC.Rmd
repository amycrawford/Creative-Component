...
\begin{tabular}{l l c c c c}
    ...
    \multirow{ 2}{*}{ASSC-SVM}& 13 Predictors & ?0.70(1.5more) & ?0.40(1.5more) & - & - \\ 
...
## STEP 0
 ...
 temp <- predictions[,1:72]
####### vote and predict
 voting <- function(x){
   sum(x == "functional")
 }
 
 preds_assc <- ifelse(apply(temp, 1, voting) >= 36, "functional", "requires attention")
 confusionMatrix(preds_assc, test_13_small$test_y)
```
